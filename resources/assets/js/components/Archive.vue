			...
			<div class="row" style="margin-top: 30px;">
				...
				<div class="col-md-3" style="margin-top: 20px;">
					...
					<div style="margin-top: 20px;">
						...
						<template v-if="selected_card.due_date != null">
					...
					<div>
						<strong>
							<b-button variant="secondary" block @click="sendToBoard()">
								<font-awesome-icon icon="undo"></font-awesome-icon>&nbsp;&nbsp;&nbsp;Send to board
							</b-button>
						</strong>
					</div>
				</div>
	...
	export default {
		...
		methods: {
			...
			uploadAttachment() {
				...
				axios.post('../../board/newArchiveAttachment', this.form, config)
				.then((response) => {
					this.cardImg = [];
					this.cardImgPreview = '';
					// this.$refs.visitcardmodal.hide();
